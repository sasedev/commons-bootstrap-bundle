...
class TwigFormExtension extends Twig_Extension
{
	...
	{
		return array(new Twig_SimpleFunction('bootstrap_set_style', array($this, 'setStyle')), 
			...
			new Twig_SimpleFunction('checkbox_row', null, 
				array('node_class' => 'Symfony\Bridge\Twig\Node\SearchAndRenderBlockNode', 'is_safe' => array('html'))), 
			new Twig_SimpleFunction('radio_row', null, 
				array('node_class' => 'Symfony\Bridge\Twig\Node\SearchAndRenderBlockNode', 'is_safe' => array('html'))), 
			new Twig_SimpleFunction('global_form_errors', null, 
				array('node_class' => 'Symfony\Bridge\Twig\Node\SearchAndRenderBlockNode', 'is_safe' => array('html'))));
	}
	...
	{
		return 'Sasedev.Commons.Bootstrap.Extension.TwigForm';
	}
}
